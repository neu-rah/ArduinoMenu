...
struct TextFmt:public O {
  public:
    ...
    static inline void fmtMode(idx_t n,const Nav& nav,const Out& out) {
    ...
    template<bool io,typename I,typename Out,typename Nav>
    static inline void fmtItem(idx_t n,const Nav& nav,const Out& out) {
    ...
    template<bool io,typename I,typename Out,typename Nav>
    static inline void fmtIndex(idx_t n,const Nav& nav,const Out& out) {
      if(io) {
    ...
    template<bool io,typename I,typename Out,typename Nav>
    static inline void fmtCursor(idx_t n,const Nav& nav,const Out& out) {
      if (io) {
